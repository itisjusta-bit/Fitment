...
export default function OnboardingStep2() {
  ...
  const progressAnim = useRef(new Animated.Value(1)).current; // Start at step 1
  ...
  const handleNext = () => {
    ...
    // Save to local state/context here before final submit
    console.log("Stats:", { gender, age, weight, height });
    
    // Move to Step 3
     router.push('/(auth)/onboarding/3');
    // alert('Stats saved! Ready for Step 3.');
  };
  ...
  return (
    ...
    >
      <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
        ...
        {/* Premium Thin Progress Bar (Now at 2/7) */}
            ...
            <View style={styles.row}>
              {['Male', 'Female'].map((g) => {
                ...
                return (
                  <Pressable 
                    key={g}
                    style={[styles.glassCard, styles.flexCard, isSelected && styles.glassCardSelected]}
                    onPress={() => setGender(g)}
                  >
          ...
          <View style={styles.footer}>
            <Pressable 
              style={[
                ...
                (!gender || !age || !weight || !height) && styles.primaryButtonDisabled
              ]} 
              onPress={handleNext}
            >
...
const styles = StyleSheet.create({
  ...
  footer: {
    ...
    left: 24,
    right: 24,
    paddingBottom: 32, // Safe area space
    paddingTop: 16,
  },
  primaryButton: {
    height: 56,
